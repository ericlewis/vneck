...
- (ItemViewController *)viewControllerAtIndex:(NSUInteger)index storyboard:(UIStoryboard *)storyboard {
    ...
    ItemViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"DataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(ItemViewController *)viewController];
